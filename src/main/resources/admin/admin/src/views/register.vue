  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(30, 136, 229, 1);fontSize:28px;">疫情下图书馆管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="住址" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.zhuzhi" autocomplete="off" placeholder="住址"  />
			</el-form-item>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210514/feb0b3bd564845b58c838bbd0d251aa0.png");
		height: 100vh;
